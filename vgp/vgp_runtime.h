...
#define VFEATURE_SAVE_SIZE 0x0003
#define VFEATURE_RTC_SUPPORT 0x0004

#define VFUNC_SCREEN_PIXEL 0x000100
...
#define VFUNC_SYSTEM_EXIT 0x000103
    ...
    #define VFUNC_RTC_GET_OFFSET 0x000400
    #define VFUNC_RTC_SET_OFFSET 0x000401
    #define VFUNC_RTC_GET_TIME 0x000402
    #define VFUNC_RTC_SET_TIME 0x000403
#endif
